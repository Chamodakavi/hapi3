  ...
  return (
    <section className="my-20">
      <div className="container mx-auto px-4 font-montserrat">
        ...
        {/* card */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 space-y-10 sm:space-y-10">
          {/* card 1 */}
          <div className=" w-full h-[400] sm:h-[450px] md:h-[400] lg:h-[470] ">
            ...
            {/* card bottom */}
            <div className="relative bottom-60 sm:bottom-60 md:bottom-50 lg:bottom-70 bg-yellow border-1 p-5 w-[95%]">
